...
func (m *MsgNewAuctionRoundResponse) Reset()         { *m = MsgNewAuctionRoundResponse{} }
func (m *MsgNewAuctionRoundResponse) String() string { return proto.CompactTextString(m) }
...
func (m *MsgNewAuctionRoundResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MsgNewAuctionRoundResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MsgNewAuctionRoundResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MsgNewAuctionRoundResponse.Merge(m, src)
}
func (m *MsgNewAuctionRoundResponse) XXX_Size() int {
	return m.Size()
}
func (m *MsgNewAuctionRoundResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_MsgNewAuctionRoundResponse.DiscardUnknown(m)
}

var xxx_messageInfo_MsgNewAuctionRoundResponse proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*MsgNewAuctionRoundResponse)(nil), "injective.auction.v1beta1.MsgNewAuctionRoundResponse")
...
var fileDescriptor_0943fd5f0d415547 = []byte{
	...
	,
}
...
func (m *MsgNewAuctionRoundResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MsgNewAuctionRoundResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MsgNewAuctionRoundResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex

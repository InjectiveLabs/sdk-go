...
func TestParseChainID(t *testing.T) {
	testCases := []struct {
		...
		{
			"valid chain-id, single digit", "1", false, big.NewInt(1),
		},
		{
			"valid chain-id, multiple digits", "aragonchain-256", true, big.NewInt(256),
		},
		{
		...
		{
			"invalid epoch, cannot start with 0", "injective-001", true, nil,
		},
		{
			"invalid epoch, cannot invalid base", "injective-0x212", true, nil,
		},
		{
			"invalid epoch, non-integer", "injective-injective", true, nil,
		},
		{
			"invalid epoch, undefined", "injective-", true, nil,
		},
		{
		...
		{
			"long chain-id", "injective-" + strings.Repeat("1", 40), true, nil,
		},
	}

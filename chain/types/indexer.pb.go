...
func init() {
	proto.RegisterType((*TxResult)(nil), "injective.types.v1beta1.TxResult")
}

func init() {
	proto.RegisterFile("injective/types/v1beta1/indexer.proto", fileDescriptor_acfe329a5110de5c)
}

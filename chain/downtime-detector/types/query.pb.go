...
type RecoveredSinceDowntimeOfLengthRequest struct {
	Downtime Downtime      `protobuf:"varint,1,opt,name=downtime,proto3,enum=injective.downtimedetector.v1beta1.Downtime" json:"downtime,omitempty" yaml:"downtime"`
...
func (*RecoveredSinceDowntimeOfLengthRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_0ce72853ddb0f317, []int{0}
}
...
type RecoveredSinceDowntimeOfLengthResponse struct {
	SuccessfullyRecovered bool `protobuf:"varint,1,opt,name=successfully_recovered,json=successfullyRecovered,proto3" json:"successfully_recovered,omitempty"`
}
...
func (*RecoveredSinceDowntimeOfLengthResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_0ce72853ddb0f317, []int{1}
}
...
func (m *RecoveredSinceDowntimeOfLengthResponse) GetSuccessfullyRecovered() bool {
	if m != nil {
		return m.SuccessfullyRecovered
	}
	return false
}

func init() {
	proto.RegisterType((*RecoveredSinceDowntimeOfLengthRequest)(nil), "injective.downtimedetector.v1beta1.RecoveredSinceDowntimeOfLengthRequest")
	proto.RegisterType((*RecoveredSinceDowntimeOfLengthResponse)(nil), "injective.downtimedetector.v1beta1.RecoveredSinceDowntimeOfLengthResponse")
}

func init() {
	proto.RegisterFile("injective/downtimedetector/v1beta1/query.proto", fileDescriptor_0ce72853ddb0f317)
}

var fileDescriptor_0ce72853ddb0f317 = []byte{
	// 503 bytes of a gzipped FileDescriptorProto
	,
}
...
func (c *queryClient) RecoveredSinceDowntimeOfLength(ctx context.Context, in *RecoveredSinceDowntimeOfLengthRequest, opts ...grpc.CallOption) (*RecoveredSinceDowntimeOfLengthResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/injective.downtimedetector.v1beta1.Query/RecoveredSinceDowntimeOfLength", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_RecoveredSinceDowntimeOfLength_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/injective.downtimedetector.v1beta1.Query/RecoveredSinceDowntimeOfLength",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "injective.downtimedetector.v1beta1.Query",
	...
	Metadata: "injective/downtimedetector/v1beta1/query.proto",
}
...
func (m *RecoveredSinceDowntimeOfLengthResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field SuccessfullyRecovered", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SuccessfullyRecovered = bool(v != 0)
		default:
			iNdEx = preIndex
			skippy, err := skipQuery(dAtA[iNdEx:])
			if err != nil {

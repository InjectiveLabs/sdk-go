...
// Approve is a paid mutator transaction binding the contract method 0x28e06289.
//
// Solidity: function approve(address grantee, uint8[] methods, (uint256,string)[] spendLimit, uint256 duration) returns(bool approved)
func (_ExchangeModule *ExchangeModuleTransactor) Approve(opts *bind.TransactOpts, grantee common.Address, methods []uint8, spendLimit []CosmosCoin, duration *big.Int) (*types.Transaction, error) {
	return _ExchangeModule.contract.Transact(opts, "approve", grantee, methods, spendLimit, duration)
}

// Approve is a paid mutator transaction binding the contract method 0x28e06289.
//
// Solidity: function approve(address grantee, uint8[] methods, (uint256,string)[] spendLimit, uint256 duration) returns(bool approved)
func (_ExchangeModule *ExchangeModuleSession) Approve(grantee common.Address, methods []uint8, spendLimit []CosmosCoin, duration *big.Int) (*types.Transaction, error) {
	return _ExchangeModule.Contract.Approve(&_ExchangeModule.TransactOpts, grantee, methods, spendLimit, duration)
}

// Approve is a paid mutator transaction binding the contract method 0x28e06289.
//
// Solidity: function approve(address grantee, uint8[] methods, (uint256,string)[] spendLimit, uint256 duration) returns(bool approved)
func (_ExchangeModule *ExchangeModuleTransactorSession) Approve(grantee common.Address, methods []uint8, spendLimit []CosmosCoin, duration *big.Int) (*types.Transaction, error) {
	return _ExchangeModule.Contract.Approve(&_ExchangeModule.TransactOpts, grantee, methods, spendLimit, duration)
}

...
type IBCHookCall struct {
	...
	// Input is the ABI-encoded contract call data
	Input []byte `protobuf:"bytes,2,opt,name=input,proto3" json:"input,omitempty"`
	// GasLimit is the maximum EVM gas available to the contract call
	GasLimit uint64 `protobuf:"varint,3,opt,name=gas_limit,json=gasLimit,proto3" json:"gas_limit,omitempty"`
}

func (m *IBCHookCall) Reset()         { *m = IBCHookCall{} }
func (m *IBCHookCall) String() string { return proto.CompactTextString(m) }
func (*IBCHookCall) ProtoMessage()    {}
func (*IBCHookCall) Descriptor() ([]byte, []int) {
	return fileDescriptor_7f62438576d4fe29, []int{8}
}
func (m *IBCHookCall) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *IBCHookCall) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_IBCHookCall.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *IBCHookCall) XXX_Merge(src proto.Message) {
	xxx_messageInfo_IBCHookCall.Merge(m, src)
}
func (m *IBCHookCall) XXX_Size() int {
	return m.Size()
}
func (m *IBCHookCall) XXX_DiscardUnknown() {
	xxx_messageInfo_IBCHookCall.DiscardUnknown(m)
}

var xxx_messageInfo_IBCHookCall proto.InternalMessageInfo

func (m *IBCHookCall) GetContract() []byte {
	if m != nil {
		return m.Contract
	}
	return nil
...
func (m *IBCHookCall) GetInput() []byte {
	if m != nil {
		return m.Input
	}
	return nil
...
func (m *IBCHookCall) GetGasLimit() uint64 {
	if m != nil {
		return m.GasLimit
	}
	return 0
...
func init() {
	...
	proto.RegisterType((*IBCHookCall)(nil), "injective.evm.v1.IBCHookCall")
}
...
var fileDescriptor_7f62438576d4fe29 = []byte{
	...
	,
}
...
func (m *IBCHookCall) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *IBCHookCall) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *IBCHookCall) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *IBCHookCall) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: IBCHookCall: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: IBCHookCall: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {

...
func init() {
	...
	govcod.Amino.RegisterConcrete(&SetConfigProposal{}, "injective/OcrSetConfigProposal", nil)
	govcod.Amino.RegisterConcrete(&SetBatchConfigProposal{}, "injective/OcrSetBatchConfigProposal", nil)
}

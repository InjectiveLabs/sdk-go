...
type StreamResponse struct {
	...
	BankBalances               []*BankBalance        `protobuf:"bytes,2,rep,name=bank_balances,json=bankBalances,proto3" json:"bank_balances,omitempty"`
	SubaccountDeposits         []*SubaccountDeposits `protobuf:"bytes,3,rep,name=subaccount_deposits,json=subaccountDeposits,proto3" json:"subaccount_deposits,omitempty"`
	SpotTrades                 []*SpotTrade          `protobuf:"bytes,4,rep,name=spot_trades,json=spotTrades,proto3" json:"spot_trades,omitempty"`
	DerivativeTrades           []*DerivativeTrade    `protobuf:"bytes,5,rep,name=derivative_trades,json=derivativeTrades,proto3" json:"derivative_trades,omitempty"`
	SpotOrders                 []*SpotOrder          `protobuf:"bytes,6,rep,name=spot_orders,json=spotOrders,proto3" json:"spot_orders,omitempty"`
	DerivativeOrders           []*DerivativeOrder    `protobuf:"bytes,7,rep,name=derivative_orders,json=derivativeOrders,proto3" json:"derivative_orders,omitempty"`
	SpotOrderbookUpdates       []*OrderbookUpdate    `protobuf:"bytes,8,rep,name=spot_orderbook_updates,json=spotOrderbookUpdates,proto3" json:"spot_orderbook_updates,omitempty"`
	DerivativeOrderbookUpdates []*OrderbookUpdate    `protobuf:"bytes,9,rep,name=derivative_orderbook_updates,json=derivativeOrderbookUpdates,proto3" json:"derivative_orderbook_updates,omitempty"`
	Positions                  []*Position           `protobuf:"bytes,10,rep,name=positions,proto3" json:"positions,omitempty"`
	OraclePrices               []*OraclePrice        `protobuf:"bytes,11,rep,name=oracle_prices,json=oraclePrices,proto3" json:"oracle_prices,omitempty"`
}
...
func (m *StreamResponse) GetSpotOrders() []*SpotOrder {
	if m != nil {
		return m.SpotOrders
	}
	return nil
...
func (m *StreamResponse) GetDerivativeOrders() []*DerivativeOrder {
	if m != nil {
...
var fileDescriptor_e23b7dcfb2fbc9c7 = []byte{
	...
	,
}
...
func (m *StreamResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			...
			m.DerivativeOrders = append(m.DerivativeOrders, &DerivativeOrder{})

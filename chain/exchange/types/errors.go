...
var (
	...
	ErrLimitOrderAlreadyExists                  = sdkerrors.Register(ModuleName, 39, "Subaccount cannot place a market order when a limit order in the same market was already placed in the same block")

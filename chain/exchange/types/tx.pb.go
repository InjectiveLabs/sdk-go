...
// MsgSubscribeToMarketMakingPool defines the Msg/SubscribeToMarketMakingPool message type
type MsgSubscribeToMarketMakingPool struct {
	Sender                 string `protobuf:"bytes,1,opt,name=sender,proto3" json:"sender,omitempty"`
	MarketId               string `protobuf:"bytes,2,opt,name=market_id,json=marketId,proto3" json:"market_id,omitempty"`
	PoolSubaccountId       string `protobuf:"bytes,3,opt,name=pool_subaccount_id,json=poolSubaccountId,proto3" json:"pool_subaccount_id,omitempty"`
	SubscriberSubaccountId string `protobuf:"bytes,4,opt,name=subscriber_subaccount_id,json=subscriberSubaccountId,proto3" json:"subscriber_subaccount_id,omitempty"`
	// funds amount defines the amount of funds that will be used from the subscriber
	FundsAmount *github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,5,opt,name=funds_amount,json=fundsAmount,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"funds_amount,omitempty"`
	// subscriber margin ratio defines the ratio of margin to notional to be used for opening the subscriber position
	SubscriberMarginRatio *github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,6,opt,name=subscriber_margin_ratio,json=subscriberMarginRatio,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"subscriber_margin_ratio,omitempty"`
	ContractAddressMaker  string                                  `protobuf:"bytes,7,opt,name=contract_address_maker,json=contractAddressMaker,proto3" json:"contract_address_maker,omitempty"`
}

func (m *MsgSubscribeToMarketMakingPool) Reset()         { *m = MsgSubscribeToMarketMakingPool{} }
func (m *MsgSubscribeToMarketMakingPool) String() string { return proto.CompactTextString(m) }
func (*MsgSubscribeToMarketMakingPool) ProtoMessage()    {}
func (*MsgSubscribeToMarketMakingPool) Descriptor() ([]byte, []int) {
	return fileDescriptor_bd45b74cb6d81462, []int{41}
}
func (m *MsgSubscribeToMarketMakingPool) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MsgSubscribeToMarketMakingPool) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MsgSubscribeToMarketMakingPool.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MsgSubscribeToMarketMakingPool) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MsgSubscribeToMarketMakingPool.Merge(m, src)
}
func (m *MsgSubscribeToMarketMakingPool) XXX_Size() int {
	return m.Size()
}
func (m *MsgSubscribeToMarketMakingPool) XXX_DiscardUnknown() {
	xxx_messageInfo_MsgSubscribeToMarketMakingPool.DiscardUnknown(m)
}

var xxx_messageInfo_MsgSubscribeToMarketMakingPool proto.InternalMessageInfo

// MsgSubscribeToMarketMakingPoolResponse defines the Msg/SubscribeToMarketMakingPoolResponse response type.
type MsgSubscribeToMarketMakingPoolResponse struct {
}

func (m *MsgSubscribeToMarketMakingPoolResponse) Reset() {
	*m = MsgSubscribeToMarketMakingPoolResponse{}
}
func (m *MsgSubscribeToMarketMakingPoolResponse) String() string { return proto.CompactTextString(m) }
func (*MsgSubscribeToMarketMakingPoolResponse) ProtoMessage()    {}
func (*MsgSubscribeToMarketMakingPoolResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_bd45b74cb6d81462, []int{42}
}
func (m *MsgSubscribeToMarketMakingPoolResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MsgSubscribeToMarketMakingPoolResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MsgSubscribeToMarketMakingPoolResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MsgSubscribeToMarketMakingPoolResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MsgSubscribeToMarketMakingPoolResponse.Merge(m, src)
}
func (m *MsgSubscribeToMarketMakingPoolResponse) XXX_Size() int {
	return m.Size()
}
func (m *MsgSubscribeToMarketMakingPoolResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_MsgSubscribeToMarketMakingPoolResponse.DiscardUnknown(m)
}

var xxx_messageInfo_MsgSubscribeToMarketMakingPoolResponse proto.InternalMessageInfo

// MsgRedeemFromMarketMakingPool defines the Msg/RedeemFromMarketMakingPool message type
type MsgRedeemFromMarketMakingPool struct {
	Sender               string `protobuf:"bytes,1,opt,name=sender,proto3" json:"sender,omitempty"`
	MarketId             string `protobuf:"bytes,2,opt,name=market_id,json=marketId,proto3" json:"market_id,omitempty"`
	PoolSubaccountId     string `protobuf:"bytes,3,opt,name=pool_subaccount_id,json=poolSubaccountId,proto3" json:"pool_subaccount_id,omitempty"`
	RedeemerSubaccountId string `protobuf:"bytes,4,opt,name=redeemer_subaccount_id,json=redeemerSubaccountId,proto3" json:"redeemer_subaccount_id,omitempty"`
	// lp token burn amount defines the amount of lp tokens that will be burnt from the redeemer
	LpTokenBurnAmount    *github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,5,opt,name=lp_token_burn_amount,json=lpTokenBurnAmount,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"lp_token_burn_amount,omitempty"`
	ContractAddressMaker string                                  `protobuf:"bytes,6,opt,name=contract_address_maker,json=contractAddressMaker,proto3" json:"contract_address_maker,omitempty"`
}

func (m *MsgRedeemFromMarketMakingPool) Reset()         { *m = MsgRedeemFromMarketMakingPool{} }
func (m *MsgRedeemFromMarketMakingPool) String() string { return proto.CompactTextString(m) }
func (*MsgRedeemFromMarketMakingPool) ProtoMessage()    {}
func (*MsgRedeemFromMarketMakingPool) Descriptor() ([]byte, []int) {
	return fileDescriptor_bd45b74cb6d81462, []int{43}
}
func (m *MsgRedeemFromMarketMakingPool) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MsgRedeemFromMarketMakingPool) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MsgRedeemFromMarketMakingPool.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MsgRedeemFromMarketMakingPool) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MsgRedeemFromMarketMakingPool.Merge(m, src)
}
func (m *MsgRedeemFromMarketMakingPool) XXX_Size() int {
	return m.Size()
}
func (m *MsgRedeemFromMarketMakingPool) XXX_DiscardUnknown() {
	xxx_messageInfo_MsgRedeemFromMarketMakingPool.DiscardUnknown(m)
}

var xxx_messageInfo_MsgRedeemFromMarketMakingPool proto.InternalMessageInfo

// MsgRedeemFromMarketMakingPoolResponse defines the Msg/RedeemFromMarketMakingPoolResponse response type.
type MsgRedeemFromMarketMakingPoolResponse struct {
}

func (m *MsgRedeemFromMarketMakingPoolResponse) Reset()         { *m = MsgRedeemFromMarketMakingPoolResponse{} }
func (m *MsgRedeemFromMarketMakingPoolResponse) String() string { return proto.CompactTextString(m) }
func (*MsgRedeemFromMarketMakingPoolResponse) ProtoMessage()    {}
func (*MsgRedeemFromMarketMakingPoolResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_bd45b74cb6d81462, []int{44}
}
func (m *MsgRedeemFromMarketMakingPoolResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MsgRedeemFromMarketMakingPoolResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MsgRedeemFromMarketMakingPoolResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MsgRedeemFromMarketMakingPoolResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MsgRedeemFromMarketMakingPoolResponse.Merge(m, src)
}
func (m *MsgRedeemFromMarketMakingPoolResponse) XXX_Size() int {
	return m.Size()
}
func (m *MsgRedeemFromMarketMakingPoolResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_MsgRedeemFromMarketMakingPoolResponse.DiscardUnknown(m)
}

var xxx_messageInfo_MsgRedeemFromMarketMakingPoolResponse proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*MsgSubscribeToMarketMakingPool)(nil), "injective.exchange.v1beta1.MsgSubscribeToMarketMakingPool")
	proto.RegisterType((*MsgSubscribeToMarketMakingPoolResponse)(nil), "injective.exchange.v1beta1.MsgSubscribeToMarketMakingPoolResponse")
	proto.RegisterType((*MsgRedeemFromMarketMakingPool)(nil), "injective.exchange.v1beta1.MsgRedeemFromMarketMakingPool")
	proto.RegisterType((*MsgRedeemFromMarketMakingPoolResponse)(nil), "injective.exchange.v1beta1.MsgRedeemFromMarketMakingPoolResponse")
...
var fileDescriptor_bd45b74cb6d81462 = []byte{
	...
	,
}
...
type MsgClient interface {
	...
	// SubscribeToMarketMakingPool defines a method for subscribing to a market making pool.
	SubscribeToMarketMakingPool(ctx context.Context, in *MsgSubscribeToMarketMakingPool, opts ...grpc.CallOption) (*MsgSubscribeToMarketMakingPoolResponse, error)
	// RedeemFromMarketMakingPool defines a method for redeeming from a market making pool.
	RedeemFromMarketMakingPool(ctx context.Context, in *MsgRedeemFromMarketMakingPool, opts ...grpc.CallOption) (*MsgRedeemFromMarketMakingPoolResponse, error)
...
func (c *msgClient) SubscribeToMarketMakingPool(ctx context.Context, in *MsgSubscribeToMarketMakingPool, opts ...grpc.CallOption) (*MsgSubscribeToMarketMakingPoolResponse, error) {
	out := new(MsgSubscribeToMarketMakingPoolResponse)
	err := c.cc.Invoke(ctx, "/injective.exchange.v1beta1.Msg/SubscribeToMarketMakingPool", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) RedeemFromMarketMakingPool(ctx context.Context, in *MsgRedeemFromMarketMakingPool, opts ...grpc.CallOption) (*MsgRedeemFromMarketMakingPoolResponse, error) {
	out := new(MsgRedeemFromMarketMakingPoolResponse)
	err := c.cc.Invoke(ctx, "/injective.exchange.v1beta1.Msg/RedeemFromMarketMakingPool", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MsgServer interface {
	...
	// SubscribeToMarketMakingPool defines a method for subscribing to a market making pool.
	SubscribeToMarketMakingPool(context.Context, *MsgSubscribeToMarketMakingPool) (*MsgSubscribeToMarketMakingPoolResponse, error)
	// RedeemFromMarketMakingPool defines a method for redeeming from a market making pool.
	RedeemFromMarketMakingPool(context.Context, *MsgRedeemFromMarketMakingPool) (*MsgRedeemFromMarketMakingPoolResponse, error)
	// CreateDerivativeLimitOrder defines a method for creating a new derivative limit order.
...
func (*UnimplementedMsgServer) SubscribeToMarketMakingPool(ctx context.Context, req *MsgSubscribeToMarketMakingPool) (*MsgSubscribeToMarketMakingPoolResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SubscribeToMarketMakingPool not implemented")
}
func (*UnimplementedMsgServer) RedeemFromMarketMakingPool(ctx context.Context, req *MsgRedeemFromMarketMakingPool) (*MsgRedeemFromMarketMakingPoolResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RedeemFromMarketMakingPool not implemented")
}
...
func _Msg_SubscribeToMarketMakingPool_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MsgSubscribeToMarketMakingPool)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MsgServer).SubscribeToMarketMakingPool(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/injective.exchange.v1beta1.Msg/SubscribeToMarketMakingPool",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MsgServer).SubscribeToMarketMakingPool(ctx, req.(*MsgSubscribeToMarketMakingPool))
	}
	return interceptor(ctx, in, info, handler)
}

func _Msg_RedeemFromMarketMakingPool_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MsgRedeemFromMarketMakingPool)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MsgServer).RedeemFromMarketMakingPool(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/injective.exchange.v1beta1.Msg/RedeemFromMarketMakingPool",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MsgServer).RedeemFromMarketMakingPool(ctx, req.(*MsgRedeemFromMarketMakingPool))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SubscribeToMarketMakingPool",
			Handler:    _Msg_SubscribeToMarketMakingPool_Handler,
		},
		{
			MethodName: "RedeemFromMarketMakingPool",
			Handler:    _Msg_RedeemFromMarketMakingPool_Handler,
		},
		{
...
func (m *MsgSubscribeToMarketMakingPool) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MsgSubscribeToMarketMakingPool) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MsgSubscribeToMarketMakingPool) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.ContractAddressMaker) > 0 {
		...
		i = encodeVarintTx(dAtA, i, uint64(len(m.ContractAddressMaker)))
		i--
		dAtA[i] = 0x3a
	}
	if m.SubscriberMarginRatio != nil {
		{
			size := m.SubscriberMarginRatio.Size()
			i -= size
			if _, err := m.SubscriberMarginRatio.MarshalTo(dAtA[i:]); err != nil {
				return 0, err
			}
			i = encodeVarintTx(dAtA, i, uint64(size))
		}
	...
	if m.FundsAmount != nil {
		{
			size := m.FundsAmount.Size()
			i -= size
			if _, err := m.FundsAmount.MarshalTo(dAtA[i:]); err != nil {
				return 0, err
			}
			i = encodeVarintTx(dAtA, i, uint64(size))
		}
	...
	if len(m.SubscriberSubaccountId) > 0 {
		i -= len(m.SubscriberSubaccountId)
		copy(dAtA[i:], m.SubscriberSubaccountId)
		i = encodeVarintTx(dAtA, i, uint64(len(m.SubscriberSubaccountId)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.PoolSubaccountId) > 0 {
		...
		i = encodeVarintTx(dAtA, i, uint64(len(m.PoolSubaccountId)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.MarketId) > 0 {
...
func (m *MsgSubscribeToMarketMakingPoolResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MsgSubscribeToMarketMakingPoolResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MsgSubscribeToMarketMakingPoolResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MsgRedeemFromMarketMakingPool) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MsgRedeemFromMarketMakingPool) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MsgRedeemFromMarketMakingPool) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.LpTokenBurnAmount != nil {
		{
			size := m.LpTokenBurnAmount.Size()
			i -= size
			if _, err := m.LpTokenBurnAmount.MarshalTo(dAtA[i:]); err != nil {
				return 0, err
			}
			i = encodeVarintTx(dAtA, i, uint64(size))
		}
	...
	if len(m.RedeemerSubaccountId) > 0 {
		i -= len(m.RedeemerSubaccountId)
		copy(dAtA[i:], m.RedeemerSubaccountId)
		i = encodeVarintTx(dAtA, i, uint64(len(m.RedeemerSubaccountId)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.PoolSubaccountId) > 0 {
...
func (m *MsgRedeemFromMarketMakingPoolResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MsgRedeemFromMarketMakingPoolResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MsgRedeemFromMarketMakingPoolResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MsgSubscribeToMarketMakingPool) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	l = len(m.SubscriberSubaccountId)
	if l > 0 {
		n += 1 + l + sovTx(uint64(l))
	}
	if m.FundsAmount != nil {
		l = m.FundsAmount.Size()
		n += 1 + l + sovTx(uint64(l))
	}
	if m.SubscriberMarginRatio != nil {
		l = m.SubscriberMarginRatio.Size()
		n += 1 + l + sovTx(uint64(l))
	}
...
func (m *MsgSubscribeToMarketMakingPoolResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MsgRedeemFromMarketMakingPool) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	l = len(m.RedeemerSubaccountId)
	if l > 0 {
		n += 1 + l + sovTx(uint64(l))
	}
	if m.LpTokenBurnAmount != nil {
		l = m.LpTokenBurnAmount.Size()
		n += 1 + l + sovTx(uint64(l))
	}
	l = len(m.ContractAddressMaker)
	if l > 0 {
...
func (m *MsgRedeemFromMarketMakingPoolResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MsgSubscribeToMarketMakingPool) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MsgSubscribeToMarketMakingPool: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MsgSubscribeToMarketMakingPool: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SubscriberSubaccountId", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SubscriberSubaccountId = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 5:
			if wireType != 2 {
			...
			m.FundsAmount = &v
			if err := m.FundsAmount.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SubscriberMarginRatio", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			var v github_com_cosmos_cosmos_sdk_types.Dec
			m.SubscriberMarginRatio = &v
			if err := m.SubscriberMarginRatio.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 7:
...
func (m *MsgSubscribeToMarketMakingPoolResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MsgSubscribeToMarketMakingPoolResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MsgSubscribeToMarketMakingPoolResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
...
func (m *MsgRedeemFromMarketMakingPool) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MsgRedeemFromMarketMakingPool: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MsgRedeemFromMarketMakingPool: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RedeemerSubaccountId", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.RedeemerSubaccountId = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field LpTokenBurnAmount", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.LpTokenBurnAmount = &v
			if err := m.LpTokenBurnAmount.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 6:
...
func (m *MsgRedeemFromMarketMakingPoolResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MsgRedeemFromMarketMakingPoolResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MsgRedeemFromMarketMakingPoolResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex

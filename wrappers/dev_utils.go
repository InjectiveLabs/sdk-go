...
//
// Solidity: function decodeZeroExTransactionData(bytes transactionData) constant returns(string functionName, []ZOrder orders, uint256[] takerAssetFillAmounts, bytes[] signatures)
...
//
// Solidity: function getOrderRelevantStates([]ZOrder orders, bytes[] signatures) constant returns([]OrderInfo ordersInfo, uint256[] fillableTakerAssetAmounts, bool[] isValidSignature)
...
//
// Solidity: function getSimulatedOrdersTransferResults([]ZOrder orders, address[] takerAddresses, uint256[] takerAssetFillAmounts) returns(uint8[] orderTransferResults)

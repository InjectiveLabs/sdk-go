...
// ExchangeCallerSession is an auto generated read-only Go binding around an Klaytn contract,
...
// ExchangeTransactorSession is an auto generated write-only Go binding around an Klaytn contract,
...
//
// Solidity: function batchCancelOrders([]ZOrder orders) returns()
...
//
// Solidity: function batchFillOrKillOrders([]ZOrder orders, uint256[] takerAssetFillAmounts, bytes[] signatures) returns([]Struct5 fillResults)
...
//
// Solidity: function batchFillOrders([]ZOrder orders, uint256[] takerAssetFillAmounts, bytes[] signatures) returns([]Struct5 fillResults)
...
//
// Solidity: function batchFillOrdersNoThrow([]ZOrder orders, uint256[] takerAssetFillAmounts, bytes[] signatures) returns([]Struct5 fillResults)
...
//
// Solidity: function batchMatchOrders([]ZOrder leftOrders, []ZOrder rightOrders, bytes[] leftSignatures, bytes[] rightSignatures) returns(Struct4 batchMatchedFillResults)
...
//
// Solidity: function batchMatchOrdersWithMaximalFill([]ZOrder leftOrders, []ZOrder rightOrders, bytes[] leftSignatures, bytes[] rightSignatures) returns(Struct4 batchMatchedFillResults)
...
//
// Solidity: function marketBuyOrdersFillOrKill([]ZOrder orders, uint256 makerAssetFillAmount, bytes[] signatures) returns(Struct5 fillResults)
...
//
// Solidity: function marketBuyOrdersNoThrow([]ZOrder orders, uint256 makerAssetFillAmount, bytes[] signatures) returns(Struct5 fillResults)
...
//
// Solidity: function marketSellOrdersFillOrKill([]ZOrder orders, uint256 takerAssetFillAmount, bytes[] signatures) returns(Struct5 fillResults)
...
//
// Solidity: function marketSellOrdersNoThrow([]ZOrder orders, uint256 takerAssetFillAmount, bytes[] signatures) returns(Struct5 fillResults)

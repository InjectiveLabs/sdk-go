...
//
// Solidity: function positions(uint256 ) view returns(bytes32 subAccountID, bytes32 marketID, uint8 direction, uint256 quantity, uint256 contractPrice, uint256 margin, int256 cumulativeFundingEntry)
...
//
// Solidity: event FuturesNettedPosition(uint256 positionID, bytes32 subAccountId, address indexed makerAddress, bytes32 indexed marketID, uint256 margin, uint256 contractPrice, uint256 quantity, int256 cumulativeFundingEntry, bool isLong)

...
// MixinPositionsSettleResults is an auto generated low-level Go binding around an user-defined struct.
type MixinPositionsSettleResults struct {
	PositionID *big.Int
	Quantity   *big.Int
	TxFees     *big.Int
}
...
// BatchDepositFor is a paid mutator transaction binding the contract method 0xf826e4b3.
//
// Solidity: function batchDepositFor(address[] baseCurrencies, bytes32[] subAccountIDs, uint256[] amounts) returns()
func (f *FuturesTransactor) BatchDepositFor(opts *bind.TransactOpts, baseCurrencies []common.Address, subAccountIDs [][32]byte, amounts []*big.Int) (*types.Transaction, error) {
	return f.contract.Transact(opts, "batchDepositFor", baseCurrencies, subAccountIDs, amounts)
}

// BatchDepositFor is a paid mutator transaction binding the contract method 0xf826e4b3.
//
// Solidity: function batchDepositFor(address[] baseCurrencies, bytes32[] subAccountIDs, uint256[] amounts) returns()
func (f *FuturesSession) BatchDepositFor(baseCurrencies []common.Address, subAccountIDs [][32]byte, amounts []*big.Int) (*types.Transaction, error) {
	return f.Contract.BatchDepositFor(&f.TransactOpts, baseCurrencies, subAccountIDs, amounts)
}

// BatchDepositFor is a paid mutator transaction binding the contract method 0xf826e4b3.
//
// Solidity: function batchDepositFor(address[] baseCurrencies, bytes32[] subAccountIDs, uint256[] amounts) returns()
func (f *FuturesTransactorSession) BatchDepositFor(baseCurrencies []common.Address, subAccountIDs [][32]byte, amounts []*big.Int) (*types.Transaction, error) {
	return f.Contract.BatchDepositFor(&f.TransactOpts, baseCurrencies, subAccountIDs, amounts)
}
...
//
// Solidity: function settleExpiryFuturesPosition(bytes32 marketID, bytes32 subaccountID) returns((uint256,uint256,uint256) results)

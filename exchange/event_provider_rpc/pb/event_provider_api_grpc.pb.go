...
type EventProviderAPIClient interface {
	...
	GetRawBlockEvents(ctx context.Context, in *GetRawBlockEventsRequest, opts ...grpc.CallOption) (*GetRawBlockEventsResponse, error)
}
...
func (c *eventProviderAPIClient) GetRawBlockEvents(ctx context.Context, in *GetRawBlockEventsRequest, opts ...grpc.CallOption) (*GetRawBlockEventsResponse, error) {
	out := new(GetRawBlockEventsResponse)
	err := c.cc.Invoke(ctx, "/event_provider_api.EventProviderAPI/GetRawBlockEvents", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type EventProviderAPIServer interface {
	...
	// Get raw block events for selected height
	GetRawBlockEvents(context.Context, *GetRawBlockEventsRequest) (*GetRawBlockEventsResponse, error)
...
func (UnimplementedEventProviderAPIServer) GetRawBlockEvents(context.Context, *GetRawBlockEventsRequest) (*GetRawBlockEventsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetRawBlockEvents not implemented")
}
...
func _EventProviderAPI_GetRawBlockEvents_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetRawBlockEventsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(EventProviderAPIServer).GetRawBlockEvents(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/event_provider_api.EventProviderAPI/GetRawBlockEvents",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EventProviderAPIServer).GetRawBlockEvents(ctx, req.(*GetRawBlockEventsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var EventProviderAPI_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetRawBlockEvents",
			Handler:    _EventProviderAPI_GetRawBlockEvents_Handler,
		},
	},

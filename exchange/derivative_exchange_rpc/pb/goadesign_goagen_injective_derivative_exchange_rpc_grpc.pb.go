...
type InjectiveDerivativeExchangeRPCClient interface {
	...
	StreamPositionsV2(ctx context.Context, in *StreamPositionsV2Request, opts ...grpc.CallOption) (InjectiveDerivativeExchangeRPC_StreamPositionsV2Client, error)
...
func (c *injectiveDerivativeExchangeRPCClient) StreamPositionsV2(ctx context.Context, in *StreamPositionsV2Request, opts ...grpc.CallOption) (InjectiveDerivativeExchangeRPC_StreamPositionsV2Client, error) {
	stream, err := c.cc.NewStream(ctx, &InjectiveDerivativeExchangeRPC_ServiceDesc.Streams[4], "/injective_derivative_exchange_rpc.InjectiveDerivativeExchangeRPC/StreamPositionsV2", opts...)
	if err != nil {
		return nil, err
	}
	x := &injectiveDerivativeExchangeRPCStreamPositionsV2Client{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type InjectiveDerivativeExchangeRPC_StreamPositionsV2Client interface {
	Recv() (*StreamPositionsV2Response, error)
	grpc.ClientStream
}

type injectiveDerivativeExchangeRPCStreamPositionsV2Client struct {
	grpc.ClientStream
}

func (x *injectiveDerivativeExchangeRPCStreamPositionsV2Client) Recv() (*StreamPositionsV2Response, error) {
...
func (c *injectiveDerivativeExchangeRPCClient) StreamTradesV2(ctx context.Context, in *StreamTradesV2Request, opts ...grpc.CallOption) (InjectiveDerivativeExchangeRPC_StreamTradesV2Client, error) {
	stream, err := c.cc.NewStream(ctx, &InjectiveDerivativeExchangeRPC_ServiceDesc.Streams[7], "/injective_derivative_exchange_rpc.InjectiveDerivativeExchangeRPC/StreamTradesV2", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *injectiveDerivativeExchangeRPCClient) StreamOrdersHistory(ctx context.Context, in *StreamOrdersHistoryRequest, opts ...grpc.CallOption) (InjectiveDerivativeExchangeRPC_StreamOrdersHistoryClient, error) {
	stream, err := c.cc.NewStream(ctx, &InjectiveDerivativeExchangeRPC_ServiceDesc.Streams[8], "/injective_derivative_exchange_rpc.InjectiveDerivativeExchangeRPC/StreamOrdersHistory", opts...)
	if err != nil {
		return nil, err
	}
...
type InjectiveDerivativeExchangeRPCServer interface {
	...
	// StreamPositionsV2 streams derivatives position updates.
	StreamPositionsV2(*StreamPositionsV2Request, InjectiveDerivativeExchangeRPC_StreamPositionsV2Server) error
	// StreamOrders streams updates to individual orders of a Derivative Market.
...
func (UnimplementedInjectiveDerivativeExchangeRPCServer) StreamPositionsV2(*StreamPositionsV2Request, InjectiveDerivativeExchangeRPC_StreamPositionsV2Server) error {
...
func _InjectiveDerivativeExchangeRPC_StreamPositionsV2_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(StreamPositionsV2Request)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(InjectiveDerivativeExchangeRPCServer).StreamPositionsV2(m, &injectiveDerivativeExchangeRPCStreamPositionsV2Server{stream})
}

type InjectiveDerivativeExchangeRPC_StreamPositionsV2Server interface {
	Send(*StreamPositionsV2Response) error
	grpc.ServerStream
}

type injectiveDerivativeExchangeRPCStreamPositionsV2Server struct {
	grpc.ServerStream
}

func (x *injectiveDerivativeExchangeRPCStreamPositionsV2Server) Send(m *StreamPositionsV2Response) error {
	return x.ServerStream.SendMsg(m)
}
...
var InjectiveDerivativeExchangeRPC_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		},
		{
			...
			Handler:       _InjectiveDerivativeExchangeRPC_StreamPositionsV2_Handler,
			ServerStreams: true,
		},
		{

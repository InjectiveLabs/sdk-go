...
func (c *eventProviderAPIClient) GetABCIBlockEventsAtHeight(ctx context.Context, in *GetABCIBlockEventsAtHeightRequest, opts ...grpc.CallOption) (*GetABCIBlockEventsAtHeightResponse, error) {
	out := new(GetABCIBlockEventsAtHeightResponse)
	err := c.cc.Invoke(ctx, "/event_provider_api.EventProviderAPI/GetABCIBlockEventsAtHeight", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _EventProviderAPI_GetABCIBlockEventsAtHeight_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetABCIBlockEventsAtHeightRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(EventProviderAPIServer).GetABCIBlockEventsAtHeight(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/event_provider_api.EventProviderAPI/GetABCIBlockEventsAtHeight",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EventProviderAPIServer).GetABCIBlockEventsAtHeight(ctx, req.(*GetABCIBlockEventsAtHeightRequest))
	}
	return interceptor(ctx, in, info, handler)
}

...
func (c *injectiveExplorerRPCClient) GetStats(ctx context.Context, in *GetStatsRequest, opts ...grpc.CallOption) (*GetStatsResponse, error) {
	out := new(GetStatsResponse)
	err := c.cc.Invoke(ctx, "/injective_explorer_rpc.InjectiveExplorerRPC/GetStats", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedInjectiveExplorerRPCServer) GetContractTxsV2(context.Context, *GetContractTxsV2Request) (*GetContractTxsV2Response, error) {
...
func (UnimplementedInjectiveExplorerRPCServer) GetStats(context.Context, *GetStatsRequest) (*GetStatsResponse, error) {
...
func _InjectiveExplorerRPC_GetContractTxsV2_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetContractTxsV2Request)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(InjectiveExplorerRPCServer).GetContractTxsV2(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
...
func _InjectiveExplorerRPC_GetStats_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetStatsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(InjectiveExplorerRPCServer).GetStats(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/injective_explorer_rpc.InjectiveExplorerRPC/GetStats",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InjectiveExplorerRPCServer).GetStats(ctx, req.(*GetStatsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var InjectiveExplorerRPC_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _InjectiveExplorerRPC_GetContractTxsV2_Handler,
		},
		{
		...
		{
			MethodName: "GetStats",
			Handler:    _InjectiveExplorerRPC_GetStats_Handler,
		},
	},

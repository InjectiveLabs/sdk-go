...
type InjectiveAuctionRPCClient interface {
	...
	AuctionsStats(ctx context.Context, in *AuctionsStatsRequest, opts ...grpc.CallOption) (*AuctionsStatsResponse, error)
}
...
func (c *injectiveAuctionRPCClient) AuctionsStats(ctx context.Context, in *AuctionsStatsRequest, opts ...grpc.CallOption) (*AuctionsStatsResponse, error) {
	out := new(AuctionsStatsResponse)
	err := c.cc.Invoke(ctx, "/injective_auction_rpc.InjectiveAuctionRPC/AuctionsStats", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type InjectiveAuctionRPCServer interface {
	...
	// Returns total INJ burnt and its total USD value in auctions.
	AuctionsStats(context.Context, *AuctionsStatsRequest) (*AuctionsStatsResponse, error)
...
func (UnimplementedInjectiveAuctionRPCServer) AuctionsStats(context.Context, *AuctionsStatsRequest) (*AuctionsStatsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AuctionsStats not implemented")
}
...
func _InjectiveAuctionRPC_AuctionsStats_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AuctionsStatsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(InjectiveAuctionRPCServer).AuctionsStats(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/injective_auction_rpc.InjectiveAuctionRPC/AuctionsStats",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InjectiveAuctionRPCServer).AuctionsStats(ctx, req.(*AuctionsStatsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var InjectiveAuctionRPC_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _InjectiveAuctionRPC_AuctionsStats_Handler,
		},
	},

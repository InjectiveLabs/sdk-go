...
//	})
//
//	amount2 := decimal.NewFromFloat(1)
//	price2 := decimal.NewFromFloat(24.5)
//
//	order2 := chainClient.SpotOrder(defaultSubaccountID, network, &chainclient.SpotOrderData{
//		OrderType:    exchangetypes.OrderType_BUY,
//		Quantity:     amount2,
//		Price:        price2,
//		FeeRecipient: senderAddress.String(),
...
//
//	msg1 := new(exchangetypes.MsgCreateSpotLimitOrder)
//	msg1.Sender = senderAddress.String()
//	msg1.Order = exchangetypes.SpotOrder(*order2)
//
